...
export class CreateFacility implements OnInit {
  ...
  createFacilityFormGroup(): FormGroup {
    return this.fb.group({
      ...
      requiresApproval: this.fb.control(false, {
        nonNullable: true,
      }),
    });
  }
  ...
  submit(): void {
    ...
    const facilities = formValue.facilities.map(
      (facility: any) => ({
        name: facility.name,
        type: facility.type,
